  ...
  if (!apiKey || showKeyScreen) {
    return (
      <div style={{
        ...
        <div style={{
          width: "100%", maxWidth: "400px", background: "#111", borderRadius: "24px", padding: "32px",
          ...
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: "26px", marginBottom: "24px", boxShadow: "0 4px 20px rgba(255,140,0,0.3)",
          }}>🤖</div>
          ...
          <input
            ...
            style={{
              ...
              fontSize: "14px", fontFamily: "inherit", outline: "none", boxSizing: "border-box", marginBottom: "16px",
            }}
          />
          <button
            onClick={() => { if (apiKeyInput.startsWith("sk-")) { setApiKey(apiKeyInput); setShowKeyScreen(false); } }}
            style={{
              width: "100%", padding: "14px",
              background: apiKeyInput.startsWith("sk-") ? "linear-gradient(135deg, #ff8c00, #ff6b00)" : "rgba(255,255,255,0.06)",
              border: "none", borderRadius: "12px", color: "#fff", fontSize: "15px", fontWeight: 700,
              cursor: apiKeyInput.startsWith("sk-") ? "pointer" : "default", fontFamily: "inherit",
            }}
          >Запустити →</button>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px", display: "flex", flexDirection: "column", gap: "12px" }}>
          {messages.map((msg, i) => (
            <div key={i} style={{
              ...
              gap: "8px", alignItems: "flex-end", animation: "fadeUp 0.25s ease",
            }}>
              {msg.role === "assistant" && (
                <div style={{
